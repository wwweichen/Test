...
/***/ (function (module, exports, __webpack_require__) {
            ...
            var defaultOptions = {
                ...
                defaultUrl: {
                    value: filepath,
                    //value: '/pdfjs-2.0.943-dist/web/compressed.tracemonkey-pldi-09.pdf',
                    kind: OptionKind.VIEWER
                },
                defaultZoomValue: {
                    value: '',
                ...
                workerSrc: {
                    value: '/pdfjs-2.0.943-dist/build/pdf.worker.js',
                    kind: OptionKind.WORKER
                }
            };
            {
...
function setButLocation() {
    //加载左右两边点击框-weichen-start
    var viewer_width = $('#viewer').width();
    var Leftwidth = 0;
    if (viewer_width < 1710)
    {
        Leftwidth = 200;
    }
    //alert(viewer_width);
    var viewer_page_width = $('#viewer').children('.page').eq(0).width();
    //alert(viewer_page_width);
    var viewer_width_s = viewer_width - viewer_page_width;
    //alert(viewer_width_s);
    var viewer_width_s1 = viewer_width_s / 2;
    var viewer_page_width1 = viewer_page_width + viewer_width_s1 + 10;
    viewer_page_width1 = viewer_page_width1 + Leftwidth;
    viewer_page_width_right = viewer_page_width1 + 'px';
    $('#ddclick-tool-right_top').css('left', viewer_page_width_right);
    var viewer_page_width_left = viewer_page_width1 - viewer_page_width - 15 - 100;
    //alert(viewer_page_width_left);
    var viewer_page_width_left1 = viewer_page_width_left;
    //alert(viewer_page_width_left1);
    viewer_page_width_left1 = viewer_page_width_left1 + 'px';
    $('#ddclick-tool-left_top').css('left', viewer_page_width_left1);
    //加载左右两边点击框-weichen-end
